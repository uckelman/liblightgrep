...
SCOPE_FIXTURE_CTOR(searchWhackZTest, STest, STest(R"(\Z)")) {
  SCOPE_ASSERT(fixture.parsesButNotValid());
}

SCOPE_FIXTURE_CTOR(searchAWhackZTest, STest, STest(R"(a\Z)")) {
  const char text[] = "aaabaacabbabcacbaccbbbcbccca";
  fixture.search(text, text + 28, 0);
  SCOPE_ASSERT_EQUAL(1u, fixture.Hits.size());
...
SCOPE_FIXTURE_CTOR(searchWhackAaWhackZTooLongTest, STest, STest(R"(\Aa\Z)")) {
  const char text[] = "aaabaacabbabcacbaccbbbcbccca";
  fixture.search(text, text + 28, 0);
  SCOPE_ASSERT_EQUAL(0u, fixture.Hits.size());
}

SCOPE_FIXTURE_CTOR(searchWhackAaWhackZTest, STest, STest(R"(\Aa\Z)")) {
  const char text[] = "a";
...
SCOPE_FIXTURE_CTOR(jennyPositiveSearch, STest, STest(R"((?<=\D)\d{7}(?=\D))")) {
